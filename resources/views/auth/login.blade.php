...
<div class="uk-section uk-section-small uk-section-muted uk-flex uk-flex-center">
  <div class="uk-card uk-card-default uk-card-body uk-width-large">
    <h2 class="uk-card-title">{{ Request::route()->getName() == 'login'? 'Contestant': 'Admin'  }} Login</h2>
    <form method="POST" action="{{ Request::route()->getName() == 'login'? route('process_login'): route('process_admin_login')  }}" class="uk-form-stacked">
      @csrf
        <div class="uk-margin">
