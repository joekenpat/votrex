@extends('layouts.app')
@section('title', 'List of Aprroved Application')
@section('content')
          ...
          <tr>
            ...
            <td>
              <div>
                ...
                <a onclick="confirm_action(event, this)"
                  href="{{ route('admin_set_application',["contest_id"=>$application->contest_id,"contestant_id"=>$application->user_id,'status'=>'declined']) }}"
                  style="color:red" uk-tooltip="Decline Contestant" class="uk-icon-link uk-margin-small-right"
                  uk-icon="icon:ban; ratio:1.3"></span></a>
              </div>
            </td>
          </tr>
          @endforeach
