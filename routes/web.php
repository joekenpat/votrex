...
Route::any('/flutterwave/pay', 'PaymentController@initialize')->name('flutterwave_pay');
Route::any('/flutterwave/rave/callback', 'PaymentController@callback')->name('flutterwave_callback');
